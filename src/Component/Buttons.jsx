...
const Buttons = ({ handleRefresh, selectedRows }) => {
    ...
    const handleDelete = async () => {
        ...
        await axios({
            method: "post",
            url: `http://3.209.124.86:8080/milestone3/${slNos}`,
            headers: {
    ...
    const handleEdit = () => {
        ...
        axios
            .put(`http://3.209.124.86:8080/milestone3/edit/${slNos}?orderCurrency=${editedOrderCurrency}&companyCode=${editedCompanyCode}&distributionChannel=${editedDistributionChannel}`,
            )
            .then((response) => {
